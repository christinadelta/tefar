...
If you use TEFAR in your work, please cite the archived software version
(DOI: 10.5281/zenodo.XXXXXXX) <!-- TODO: fill in after the v1.0.0 release -->
or use the **Cite this repository** button above, which draws on
